Public Function DynamicFunc(targetWb As Workbook, param As Variant) As Object
    ...
    folderPath = Trim(CStr(param))
    If Len(folderPath) = 0 Then
        Debug.Print "[DeleteFolder] Klasor yolu belirtilmedi."
        Set DynamicFunc = Nothing
        Exit Function
    End If
    Debug.Print "[DeleteFolder] Siliniyor: " & folderPath
    Dim vbs As String
    ...
    RunVbsHidden vbs
    Debug.Print "[DeleteFolder] Silme komutu gonderildi."
    Set DynamicFunc = Nothing
End Function
'=== ORTAK YARDIMCILAR ===
