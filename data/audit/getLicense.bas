Public Function DynamicFunc(targetWb As Workbook, param As Variant) As Object
    ...
    If Len(mac) < 10 Or Left(mac, 5) = "HATA:" Or mac = "MAC_BULUNAMADI" Then
        ...
        Debug.Print "[getLicense] MAC adresi alınamadı. Lisans kaydı yapılamıyor."
...
Private Sub RegisterOrUpdate(mac As String, firmaAdi As String, userAdi As String, _
    ...
    Select Case http.Status
        ...
        Case Else
            ...
            Debug.Print "[getLicense] Lisans sunucusuna ulasılamadı. _""HTTP " & http.Status & ": " & http.responseText
    End Select
